...
public class Window2 {
	...
	private void initialize() {
		...
		panel_2.setBounds(10, 44, 716, 366);
		panel.add(panel_2);
		...
		panel_9.setBounds(10, 454, 716, 264);
		panel.add(panel_9);
		panel_9.setLayout(new GridLayout(5, 5, 20, 5));
		
		JButton btnNewButton_30 = new JButton("BUFFET");
		btnNewButton_30.setBackground(new Color(102, 255, 102));
		panel_9.add(btnNewButton_30);
